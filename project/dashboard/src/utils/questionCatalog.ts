...
export const questionCatalog: QuestionDefinition[] = [
  ...
  },
  {
    ...
    shape: 'matrix',
    visualizations: ['Diverging Likert bar chart', 'Stacked 100% bar chart'],
    subQuestions: [
  ...
  },
  {
    ...
    category: 'Nostalgia & Emotion',
    shape: 'single',
    visualizations: ['Horizontal stacked bar chart', 'Grouped bar chart'],
  ...
  },
  {
    ...
    shape: 'matrix',
    visualizations: ['Grouped horizontal bar chart', 'Radar/Spider chart'],
    subQuestions: [
  ...
  },
  {
    ...
    category: 'Brand Priorities',
    shape: 'matrix',
    visualizations: ['Average rank position chart', 'Heatmap'],
    subQuestions: [
  ...
  },
  {
    ...
    shape: 'single',
    visualizations: ['Horizontal bar chart', 'Pie chart'],
  ...
  },
  {
    ...
    category: 'Nostalgia & Emotion',
    shape: 'matrix',
    visualizations: ['Diverging Likert bar chart', 'Grouped horizontal stacked bar chart'],
    subQuestions: [
  ...
  },
  {
    ...
    category: 'Brand Perception',
    shape: 'matrix',
    visualizations: ['Diverging Likert bar chart', 'Side-by-side horizontal stacked bars'],
    subQuestions: [
  ...
  },
  {
    ...
    shape: 'matrix',
    visualizations: ['Radar/Spider chart', 'Grouped box plots'],
    subQuestions: [
  ...
  },
  {
    ...
    category: 'Competitive Standing',
    shape: 'matrix',
    visualizations: ['Horizontal bar chart', 'Stacked 100% bar chart'],
    subQuestions: [
  ...
  },
  {
    ...
    category: 'Competitive Standing',
    shape: 'single',
    visualizations: ['Horizontal stacked 100% bar chart', 'Grouped bar chart'],
